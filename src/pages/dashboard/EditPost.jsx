...
export default function EditPost() {
  ...
  const [imageBase64, setImageBase64] = useState(post?.image || null);
  ...
  // If post doesn't exist or doesn't belong to this user, kick back to dashboard
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        <h1 className="font-serif text-2xl font-medium text-ink">Edit Post</h1>
        <p className="text-sm text-gray-500 mt-1">Update your post details below.</p>
      </div>
